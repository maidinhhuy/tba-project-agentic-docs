...
**Description:** Customer tự đăng ký bằng email — tài khoản chỉ active sau khi xác nhận email. Customer đăng nhập bằng email/password và có thể đổi mật khẩu. Mỗi Customer chỉ thấy Projects của mình; Admin thấy tất cả Projects.
...
**Out of Scope:** Quên mật khẩu, 2FA, SSO — deferred v2. Đổi mật khẩu đã được promote vào scope (FR-18, Epic 6).
